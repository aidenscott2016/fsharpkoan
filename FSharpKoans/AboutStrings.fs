 ...
 (* A single character is denoted using single quotes, example: 'c',
    ...
    let ApplyWhatYouLearned() =
        ...
        let getFunFacts x =
            ...
            // x + " doubled is " + double x + ", and " + x " tripled is " + triple x
        ...
        AssertEquality "6 doubled is 12, and 6 tripled is 18!" funFactsAboutSix       // AssertEquality "7 doubled is 12, and 6 tripled is 18!" funFactsAboutSix